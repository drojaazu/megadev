 ...
 *
 * \note Valid values are JP (Japan), US (United States), and EU (Europe)
 */
#define REGION JP
#endif
 ...
 *
 * \note Valid values are NTSC and PAL. In general, use NTSC if the region
 ...
 *
 * \note Valid values are VRAM_64K and VRAM_128K
 */

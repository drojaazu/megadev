...
/*
	The Boot ROM library uses Work RAM from 0xFFF700 to 0xFFFC00 for some of its
	functionality. That range is divided into these blocks:
 ...
 */
#define BOOT_DMA_XFER_QUEUE  0x000394

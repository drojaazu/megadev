...
.word VDP_REG_MODE1 | VDP_HICOLOR_ENABLE
.word VDP_REG_MODE2 | VDP_MD_DISPLAY_MODE | VDP_DMA_ENABLE | VDP_VBLANK_ENABLE | VIDEO_SIGNAL | VDP_DISPLAY_ENABLE
.word VDP_REG_PLA_ADDR | (PLA_ADDR_DEBUG / 0x400)
.word VDP_REG_WIN_ADDR | (0xA00 / 0x400)
.word VDP_REG_PLB_ADDR | (PLB_ADDR_DEBUG / 0x2000)
.word VDP_REG_SPR_ADDR | (0xB800 / 0x200)
.word VDP_REG_SPR_ADDR2
.word VDP_REG_BGCOLOR
.word VDP_REG_HBLANK_COUNT
.word VDP_REG_MODE3 | VDP_EXTINT_ENABLE
.word VDP_REG_MODE4 | VDP_MASK_WIDTH_40CELL
.word VDP_REG_HS_ADDR | (0xBC00 / 0x400)
.word VDP_REG_PL_ADDR2
.word VDP_REG_AUTOINC | 2
.word VDP_REG_PL_SIZE | VDP_PL_64x64
.word VDP_REG_WIN_HPOS
.word VDP_REG_WIN_VPOS
.word 0

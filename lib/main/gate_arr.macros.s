...
loop:
	btst     #GA_RET_BIT, GAREG_MEMMODE+1
	beq      loop
.endm
...
loop:
  bset     #GA_DMNA_BIT,GAREG_MEMMODE+1
  btst     #GA_DMNA_BIT,GAREG_MEMMODE+1
  beq      loop
.endm
 ...
 */
.macro RESET_GA
  move.w   #0xFF00,GAREG_MEMMODE
  move.b   #0x3,(GAREG_RESET + 1)
  nop
  move.b   #0x3,(GAREG_RESET + 1)
  move.b   #0x2,(GAREG_RESET + 1)
  move.b   #0x0,(GAREG_RESET + 1)
.endm

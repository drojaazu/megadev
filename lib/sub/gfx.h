...
#ifndef MEGADEV__SUB_GFX_H
#define MEGADEV__SUB_GFX_H
...
#define XFORM_DELTA_FRAC_BITS (16 - XFORM_POS_INT_BITS)
#define XFORM_DELTA_FRAC_MASK (1 << XFORM_POS_FRAC_BITS)

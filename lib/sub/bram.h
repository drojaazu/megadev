 ...
 * \sa BRMWRITE
 */
static inline bool bram_brmwrite(BrmwriteParams const * params, u8 const * data) {
 ...
 * \sa BRMVERIFY
 */
static inline enum BrmverifyStatus bram_brmverify(BrmwriteParams const * params) {

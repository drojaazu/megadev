...
#define print_xy(x, y) (VDPPTR(_BIOS_PLANEA_ADDR + PLANE_POS(x, y, Width64)) | VRAM_W)
...
void main()
{
	...
	do
	{
		...
		do
		{
			...
			{
				VDP_CTRL_32 = (VDPPTR(_BIOS_PLANEA_ADDR + PLANE_POS(1, clearloop, Width64)) | VRAM_W);
				VDP_DATA_16 = 0;
			}
			VDP_CTRL_32 = (VDPPTR(_BIOS_PLANEA_ADDR + PLANE_POS(1, menupos + 3, Width64)) | VRAM_W);
			VDP_DATA_16 = '>';

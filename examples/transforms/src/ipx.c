...
vdp_cmd tiles = vdp_ptr(VRAMPTR(0x80)) | VRAM_W;
...
__attribute__((noreturn)) void main()
{
  ...
  *bios_vint_user = vint_user;
  ...
  do
  {
    ...
    grant_2m();
    *gareg_comcmd1 = trace_x;
    *gareg_comcmd2 = trace_y;
    *gareg_comcmd3 = trace_dx;
    *gareg_comcmd4 = trace_dy;
    ...
    *gareg_comcmd0 = 0;
    ...
    bios_load_stamp_tilemap(
      31, 31, vdp_ptr((BIOS_VDP_DEFAULT_PLANEB)) | VRAM_W, 0x80);
  } while (1);
}

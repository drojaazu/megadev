...
It turns out strapping on an additional piece of hardware with its own independent processor and RAM increases the complexity of development dramatically. If you are already familiar with Mega Drive development, you will find Mega CD programming to be notably different in regards to your game's architecture.

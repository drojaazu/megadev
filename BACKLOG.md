...
| DOC-19 | S3 | open | Sub-side registers still untranscribed from the Hardware Manual: `$FF8030`/`$FF8032` (p. 30), CDD `$FF8034`–`$FF804A` (pp. 31–33), font `$FF804C`–`$FF8056` (p. 34), rotation/scaling `$FF8058`–`$FF8066` (pp. 35–54), sub-code `$FF8068`+ (p. 55). Done: `$FF8000`–`$FF802E`. Page map in SPEC §7. |

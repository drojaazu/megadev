...
| DOC-19 | S3 | open | Sub-side registers still untranscribed: CDD comms `$FF8038`–`$FF804A` (p. 33), font `$FF804C`–`$FF8056` (p. 34), rotation/scaling `$FF8058`–`$FF8066` (pp. 35–54, the largest block by far), sub-code `$FF8068`+ (p. 55). Done: `$FF8000`–`$FF8036`. Page map in SPEC §7. |
